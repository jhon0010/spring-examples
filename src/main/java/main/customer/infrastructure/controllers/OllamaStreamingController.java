...
import main.customer.infrastructure.services.ai.OllamaStreamingAiService;
...
public class OllamaStreamingController {
    ...
    private final OllamaStreamingAiService streamingAiService;

    @Autowired
    public OllamaStreamingController(OllamaStreamingAiService streamingAiService) {
